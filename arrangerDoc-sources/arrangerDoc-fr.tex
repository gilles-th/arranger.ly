...
- \type{repla} est une {\em musique} ou une liste de {\em musique}s, mais la syntaxe avec \type{unquote '} est \startnarrower[left] acceptée~:~\type{'(musicA musicB musicC…)}.\stopnarrower
