...
\title[generalites]{GENERAL POINTS}
\subject[objectifs]{Basic goals :}
{\em arranger.ly provide an environment facilitating musical arrangement\footnote{We call musical arrangement, the re-orchestration of an original instrumentation}.}A set of functions will allow a rapid re-orchestration of a piece of music, with a minimum and reusable music encodings.
\blank[0.7em]
